...
library(ggrepel)
library(cowplot)
ggplot(cleaned_data, aes(x = time.point, y = value, color = gene.name)) + geom_point(aes(shape = rep)) + geom_line() + facet_wrap(fungus~plant) + theme_bw() + ggtitle('The expression value of plant and fungus at different time points') 
```
